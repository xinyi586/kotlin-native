...
public:
    ThreadData(pthread_t threadId) noexcept :
        threadId_(threadId), globalsThreadQueue_(GlobalsRegistry::Instance()), allocatorThreadQueue_(Allocator::Instance()) {}
    ...
    Allocator::ThreadQueue& allocatorThreadQueue() noexcept { return allocatorThreadQueue_; }

private:
    const pthread_t threadId_;
    GlobalsRegistry::ThreadQueue globalsThreadQueue_;
    ThreadLocalStorage tls_;
    Allocator::ThreadQueue allocatorThreadQueue_;
};
